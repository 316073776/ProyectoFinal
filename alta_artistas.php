	...
	if(preg_match('/[A-Z a-z áéíóúñ]{2,50}/i', $nombre)){
		if(preg_match('/[A-Z a-z áéíóúñ]{2,50}/i', $apellido)){
				...
				if(preg_match('/[A-Z a-z áéíóúñ]{2,50}/i', $nombre_artistico)){
                        		$insercion= "insert into artistas(nombre,apellido,pais_nacimiento,fecha_nacimiento,nombre_artistico) values('$nombre','$apellido','$pais_nacimiento','$fecha_nacimiento','$nombre_artistico')";
